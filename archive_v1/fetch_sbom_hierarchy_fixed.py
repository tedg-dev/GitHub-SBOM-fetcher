...
class GitHubSBOMFetcher:
    ...
    def __init__(self, github_token: str):
        """Initialize the fetcher with a GitHub token."""
    ...
    def _get_github_repo_from_npm(self, package_name: str, version: str = None) -> Optional[Tuple[str, str]]:
    ...
    def extract_dependencies(self, sbom_data: Dict[str, Any], owner: str, repo: str) -> List[GitHubDependency]:
    ...
    try:
        ...
        try:
            ...
            main_sbom_path = fetcher.save_sbom(
                ...
                repo, 
                sbom_data, 
                base_output_dir,  # Save in parent directory
                version=""
            )
